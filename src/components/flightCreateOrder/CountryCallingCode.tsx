...
const countries = [
  ...
  { value: "North)(+969", label: "Yemen (North)(+969)" },
  { value: "South)(+967", label: "Yemen (South)(+967)" },
  { value: "+260", label: "Zambia (+260)" },
  { value: "+263", label: "Zimbabwe (+263)" },
];

const CountryCallingCode: FC<{ field: ControllerRenderProps<FieldValues, any> }> = ({ field }) => {
      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <Button
            ...
            aria-expanded={open}
          >
            {field.value ? countries.find((country) => country.value === field.value)?.label : "Select language"}
